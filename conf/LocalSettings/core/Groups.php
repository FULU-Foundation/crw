...
$wgGroupPermissions['autoconfirmed']['skipcaptcha'] = true; // Autoconfirmed users are still required to complete CAPTCHA.
...
# $wgGroupPermissions['sysop']['bulkblock'] = true; // Already granted by default
